...
public extension Publisher {
  ...
  /// A variation on [share()](https://developer.apple.com/documentation/combine/publisher/3204754-share) that allows for buffering and replaying a `replay` amount of value events to future subscribers.
